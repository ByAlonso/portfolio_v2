...
<template>
  <div class="py-16">
    <h2
      class="text-4xl md:text-5xl font-black text-gradient-lime mb-16 flex items-center justify-center gap-4 pb-4"
    >
      {{ $t('timeline.title') }}
    </h2>
    ...
    <div class="relative max-w-4xl mx-auto">
      ...
      >
        ...
        <li class="relative sm:pl-16 group">
          ...
          <div
            class="card-hover rounded-2xl p-8 border border-[var(--color-secondary)] bg-[var(--color-bg-alt)]"
          >
        ...
        >
          <!-- Timeline dot -->
          <div
            class="absolute left-2 top-10 w-4 h-4 bg-[var(--color-text-tertiary)] rounded-full border-4 border-[var(--color-bg)] shadow-lg transition-all duration-300 group-hover:bg-[var(--color-secondary-hover)] group-hover:scale-125 group-hover:shadow-xl hidden sm:block"
          ></div>
          ...
          >
            ...
            <div
              class="flex flex-wrap items-center gap-3 pt-4 border-t border-[var(--color-border)]"
            >
              <div
              ...
              >
                <!-- Skill Icon -->
                <i
                  :class="skillsList.skillIcons[skill as keyof typeof skillsList.skillIcons]"
                  :alt="skill"
                  class="w-4 h-4 object-contain text-[var(--color-text-primary)]"
                  loading="lazy"
                />
                <!-- Skill Name -->
                <span
                  class="text-sm font-medium text-[var(--color-text-secondary)] cursor-default"
                  >{{ skill }}</span
                >
              </div>
            </div>
