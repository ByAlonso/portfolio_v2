...
<template>
    <section class="flex flex-col md:flex-row items-center md:items-start gap-12 p-8 sm:p-12">
        <img class="w-50 h-50 p-1 rounded-full ring-4 ring-yellow-400 shadow-2xl " :src="profilePic"
            alt="Bordered avatar">
